    ...
    <div class="footer-col">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <a href="{{ url('/') }}" class="footer-small-logo">
                                <img src="{{ asset(@$setting->logo) }}" alt="Logo" class="footer-logo p-2"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <ul class="text-light">
                        ...
                        <li class="d-flex">
                            ...
                            {{ @$setting->contact_second }}, {{ @$setting->contact4 }} {{ @$setting->contact5 }} {{
                            @$setting->contact6 }}
                            <br>
                        </li>
                        <li class="d-flex">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            ...
            <ul class="footer-social">
                ...
                <li><a href="{{ @$setting->instagram_link2 }}" target="_blank"><i class="lab la-instagram"></i></a>
                </li>
