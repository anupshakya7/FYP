                    ...
                    <div class="header-menu">
                        ...
                        <ul>
                                ...
                                <div class="dropdown-wrapper">
                                    ...
                                    <div class="dropdown-menuwrapper">
                                        ...
                                        <ul class="dropdown-links" role="menu">
                                            ...
                                            <li><a
                                                    href="{{ route('tripcategorydetail',$inB->slug) }}">{{$inB->name}}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="dropdown-menuwrapper">
                                        ...
                                        <ul class="dropdown-links" role="menu">
                                            ...
                                            <li><a
                                                    href="{{ route('tripcategorydetail',$outB->slug) }}">{{$outB->name}}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                            ...
                            <li>
                                ...
                                <a href="{{ route('frontend.testimonials') }}" class="nav-link">{{ $headerpage->title
                                    }}</a>
                                @else
                                <a href="{{ route('detail.page', $headerpage->slug) }}" class="nav-link">{{
                                    $headerpage->title }}</a>
                                @endif
                            ...
                            @if($headerpage->slug == 'about')
                            <li class="dropdown">
                                <a href="{{ url('page/about') }}" class="nav-link">ABOUT <i
                                        class="las la-angle-down"></i></a>
                                <div class="dropdown-wrapper" style="z-index: 9999;">
                                    <div class="dropdown-menuwrapper"></div>
                                    <div class="dropdown-menu-wrapper">
                                        <ul class="dropdown-links" role="menu">
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/message-from-executive-chairman') }}">Message
                                                    from Chairman</a></li>
                                            <li class="nav-item drop-item-second"><a href="{{ url('our-team') }}">Our
                                                    Team</a></li>
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/about-nepal') }}">About Nepal</a></li>
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/responsible-tourism') }}">Responsible
                                                    Tourism</a></li>
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/nepal-travel-tips') }}">Nepal Travel Tips</a>
                                            </li>
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/general-information') }}">General
                                                    Information</a></li>
                                            <li class="nav-item drop-item-second"><a
                                                    href="{{ url('/page/faqs') }}">FAQs</a></li>
                            ...
                            <li class="nav-item drop-item">
                                ...
                                @else
                                <a class="nav-link"
                                    href="{{ $menu->external_link ?? route('generalPage', $menu->title_slug) }}">
                                    {{ $menu->name }}
                                    @if ($menu->children->count() > 0) <i class="las la-angle-down"></i> @endif
                                </a>
                                @endif
                                ...
                                <ul class="dropdown-menus">
                                    ...
                                    <li>
                                        <a @if ($child->category_slug == 'page') href="{{ $child->external_link ??
                                            route('generalPages', $child->title_slug) }}" @else href="{{
                                            $child->external_link ?? route('category', $child->category_slug) }}"
                                            @endif>{{ $child->name }}
                                        </a>
                                        ...
                                        <ul class="second-dropdown-menus">
                                            ...
                                            <li class="nav-item drop-item-second">
                                                <a @if ($child1->category_slug == 'page') href="{{
                                                    $child1->external_link ?? route('generalPages', $child1->title_slug)
                                                    }}" @else href="{{ $child1->external_link ?? route('category',
                                                    $child1->category_slug) }}" @endif>{{ $child1->name }}
                                                </a>
                                            </li>
                                            @endforeach
                                        </ul>
        ...
        <div class="no-bdr1">
            <ul id="menu1">
                ...
                <li>
                    ...
                    @else
                    <a href="{{ route('detail.page', $headerpage->slug) }}" class="nav-link">{{ $headerpage->title
                        }}</a>
                    @endif
                ...
                <li class="nav-item drop-item">
                    ...
                    <ul class="dropdown-menus">
                        ...
                        <li>
                            <a @if ($child->category_slug == 'page') href="{{ $child->external_link ??
                                route('generalPages', $child->title_slug) }}" @else href="{{ $child->external_link ??
                                route('category', $child->category_slug) }}" @endif>{{ $child->name }}
                            </a>
                            @if ($child->children->count() > 0) <i class="las la-angle-down"></i> @endif
                            @if ($child->children->count() > 0)
                            <ul class="second-dropdown-menus">
                                @foreach ($child->children as $child1)
                                <li class="nav-item drop-item-second">
                                    <a @if ($child1->category_slug == 'page') href="{{ $child1->external_link ??
                                        route('generalPages', $child1->title_slug) }}" @else href="{{
                                        $child1->external_link ?? route('category', $child1->category_slug) }}"
                                        @endif>{{ $child1->name }}
                                    </a>
                                </li>
                                @endforeach
            ...
            {{-- <ul class="mobile-social-media">
                ...
                <li><a href="{{ $setting->insta_link }}" target="_blank"><i class="lab la-instagram"></i></a>
                </li>
                <li><a href="{{ $setting->youtube_link }}" target="_blank"><i class="lab la-youtube"></i></a>
                </li>
                <li><a href="{{ $setting->linkedin_link }}" target="_blank"><i class="lab la-linkedin-in"></i></a></li>
                <li><a href="{{ $setting->google_plus }}" target="_blank"><i class="lab la-google-plus-g"></i></a></li>
            </ul> --}}
            {{-- <div class="aside-logo">
                <a href="{{ url('/') }}">
                    <img src="{{@$setting->logo3}}" alt="aside-logo">
    ...
    <div class="site-alert" id="alert" hidden>
        <div class="alert-top">
            ...
            <div class="alert-information">
                ...
                <p>Become friends with Rupakotholidays to be the first one to know about exclusive deals and discounts.
                </p>
            </div>
        </div>
